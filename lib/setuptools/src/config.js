...
setuptools.app.config.settings = function (highlight, section) {
  ...
  if (highlight)
    for (var i in sections)
      if (sections.hasOwnProperty(i))
        if (sections[i].indexOf(highlight) > -1) section = i;
      ...
      '">\
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="accountLoadDelay" class="setting"> \
                    <option ' +
      (setuptools.data.config.accountLoadDelay === -1 ? "selected" : "") +
      ' value="-1">Automatic (Aggressive)</option>\
    '
  );
  ...
  for (i = 0; i <= 120; i++)
    setuptools.lightbox.build(
      ...
      " \
            <option " +
        (Number(i) === Number(setuptools.data.config.accountLoadDelay)
          ? "selected"
          : "") +
        ' value="' +
        i +
        '">' +
        (i === 0 ? "Automatic (Throttled)" : i + "s") +
        "</option> \
    "
    );
  ...
  for (i = 1; i <= 50; i++)
    setuptools.lightbox.build(
      ...
      " \
            <option " +
        (Number(i) === Number(setuptools.data.config.rowlength)
          ? "selected"
          : "") +
        ' value="' +
        i +
    ...
    ' \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="rowwrap" class="setting"> \
                    <option ' +
      (setuptools.data.config.rowwrap ? "selected" : "") +
    ...
    ' \
      ...
      '> \
                ...
                <select name="errors" class="setting">\
                    <option' +
      (setuptools.data.config.errors === true ? " selected" : "") +
      ' value="1">Yes</option> \
                    <option' +
      (setuptools.data.config.errors === false ? " selected" : "") +
      ' value="0">No</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"' +
      ...
      '> \
                ...
                <select name="exportDefault" class="setting">\
                    <option' +
      (setuptools.data.config.exportDefault === 0 ? " selected" : "") +
      ' value="0">None</option> \
                    <option' +
  ...
  for (i = 1; i < 31; i++)
    setuptools.lightbox.build(
      ...
      " \
            <option " +
        (Number(i) === Number(setuptools.data.config.giftChestWidth)
          ? "selected"
          : "") +
        ' value="' +
        i +
      ...
      ' value="1">On</option> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="pagesearch" class="setting">\
                    <option' +
      (setuptools.data.config.pagesearch === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.pagesearch === 1 ? " selected" : "") +
      ' value="1">On (Small)</option> \
                    <option' +
      (setuptools.data.config.pagesearch === 2 ? " selected" : "") +
      ' value="2">On (Full)</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
  ...
  for (i = 5; i <= 80; i++)
    setuptools.lightbox.build(
      ...
      " \
            <option " +
        (i === setuptools.data.config.totalswidth ? "selected" : "") +
        ' value="' +
        i +
        '">' +
        i +
  ...
  setuptools.lightbox.build(
    ...
    ' \
            ...
            <div class="setuptools app config settings"> \
                ...
                <option ' +
      (setuptools.data.config.totalsExportWidth === 0 ? "selected" : "") +
      ' value="0">Whole Screen</option> \
    '
  );
  ...
  for (i = 5; i <= 80; i++)
    setuptools.lightbox.build(
      ...
      " \
            <option " +
        (i === setuptools.data.config.totalsExportWidth ? "selected" : "") +
        ' value="' +
        i +
        '">' +
        i +
  ...
  setuptools.lightbox.build(
    ...
    ' \
        ...
        \
        <div class="setuptools containerSettings settings' +
      ...
      (setuptools.state.hosted === true ? " disabled" : "") +
      ">\
                    <option" +
      (setuptools.data.config.enabled === true ? " selected" : "") +
      ' value="1">Yes</option> \
                    <option' +
      (setuptools.data.config.enabled === false ? " selected" : "") +
      ' value="0">No</option> \
                </select> \
            </div> \
    '
  ...
  if (setuptools.data.config.enabled === true) {
    ...
    for (i = 5; i <= 20; i++)
      setuptools.lightbox.build(
        "settings",
        "<option" +
          (setuptools.data.config.accountsPerPage === i ? " selected" : "") +
          ' value="' +
          i +
          '" >' +
          i +
    ...
    for (i = 1; i <= 14; i++)
      setuptools.lightbox.build(
        ...
        " \
                        <option " +
          (Number(i) === Number(setuptools.data.config.autoReloadDays)
            ? "selected"
            : "") +
          ' value="' +
          i +
      ...
      ' \
                ...
                <div class="setuptools app config settings"> \
                    ...
                    <select name="badaccounts" class="setting">\
                        <option' +
        (setuptools.data.config.badaccounts === -1 ? " selected" : "") +
        ' value="-1">Off</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 0 ? " selected" : "") +
        ' value="0">Disable Invalid Accounts</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 1 ? " selected" : "") +
        ' value="1">Disable Banned Accounts</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 2 ? " selected" : "") +
        ' value="2">Delete Invalid Accounts</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 3 ? " selected" : "") +
        ' value="3">Delete Banned Accounts</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 4 ? " selected" : "") +
        ' value="4">Disable Both</option> \
                        <option' +
        (setuptools.data.config.badaccounts === 5 ? " selected" : "") +
        ' value="5">Delete Both</option> \
                    </select> \
                </div> \
                <div class="setuptools app config settings"> \
                    ...
                    <select name="groupsMergeMode" class="setting"> \
                        <option' +
        (setuptools.data.config.groupsMergeMode === 0 ? " selected" : "") +
        ' value="0">Off</option> \
                        <option' +
        (setuptools.data.config.groupsMergeMode === 1 ? " selected" : "") +
        ' value="1">On, Parallel</option> \
                        <option' +
        (setuptools.data.config.groupsMergeMode === 2 ? " selected" : "") +
        ' value="2">On, Serial</option> \
                    </select> \
                </div> \
                <div class="setuptools app config settings"> \
    ...
    for (i = 1; i < 31; i++)
      setuptools.lightbox.build(
        ...
        " \
            <option " +
          (Number(i) === Number(setuptools.data.config.maximumBackupCount)
            ? "selected"
            : "") +
          ' value="' +
          i +
  ...
  setuptools.lightbox.build(
    ...
    ' \
        ...
        \
        <div class="setuptools containerSettings advanced' +
      (section !== "advanced" ? " hidden" : "") +
      '"> \
  ...
  if (
    setuptools.config.devForcePoint === "online-versioncheck" ||
      ...
      ' \
                    <div class="setuptools app config settings"> \
                        ...
                        <select name="alertNewVersion" class="setting">\
                            <option' +
        (setuptools.data.config.alertNewVersion === 0 ? " selected" : "") +
        ' value="0">Off</option> \
                            <option' +
        (setuptools.data.config.alertNewVersion === 1 ? " selected" : "") +
        ' value="1">On, releases only</option> \
                            <option' +
        (setuptools.data.config.alertNewVersion === 2 ? " selected" : "") +
        ' value="2">On, all versions</option> \
                        </select> \
                    </div> \
            '
    );
    ...
    ' \
            <div class="setuptools app config settings"> \
                ...
                <select name="animations" class="setting"> \
                    <option' +
      (setuptools.data.config.animations === -1 ? " selected" : "") +
      ' value="-1">Minimal</option> \
                    <option' +
      (setuptools.data.config.animations === 0 ? " selected" : "") +
      ' value="0">Reduced</option> \
                    <option' +
      (setuptools.data.config.animations === 1 ? " selected" : "") +
      ' value="1">All</option> \
                </select> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="automaticBackups" class="setting">\
                    <option' +
      (setuptools.data.config.automaticBackups === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.automaticBackups === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="autocomplete" class="setting">\
                    <option' +
      (setuptools.data.config.autocomplete === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.autocomplete === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="debugging" class="setting">\
                    <option' +
      (setuptools.data.config.debugging === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.debugging === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"' +
      ...
      '> \
                ...
                <select name="equipSilhouettes" class="setting">\
                    <option' +
      (setuptools.data.config.equipSilhouettes === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.equipSilhouettes === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="hideHeaderText" class="setting">\
                    <option' +
      (setuptools.data.config.hideHeaderText === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.hideHeaderText === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
  ...
  for (var k = 0; k < setuptools.data.muledump.keys.length; k++)
    setuptools.lightbox.build(
      "settings",
      " \
        <option " +
        (k === setuptools.data.config.keyBindings ? "selected" : "") +
        ' value="' +
        k +
        '">' +
        (setuptools.data.muledump.keys[k].name || "No Name") +
        "</option> \
    "
    );
    ...
    ' \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="lazySave" class="setting">\
                    <option' +
      (setuptools.data.config.lazySave === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.lazySave === 10000 ? " selected" : "") +
      ' value="10000">10 seconds</option> \
                    <option' +
      (setuptools.data.config.lazySave === 30000 ? " selected" : "") +
      ' value="30000">30 seconds</option> \
                    <option' +
      (setuptools.data.config.lazySave === 60000 ? " selected" : "") +
      ' value="60000">1 minute</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="longpress" class="setting">\
                    <option' +
      (setuptools.data.config.longpress === 500 ? " selected" : "") +
      ' value="500">0.5 seconds</option> \
                    <option' +
      (setuptools.data.config.longpress === 1000 ? " selected" : "") +
      ' value="1000">1 second</option> \
                    <option' +
      (setuptools.data.config.longpress === 2000 ? " selected" : "") +
      ' value="2000">2 seconds</option> \
                    <option' +
      (setuptools.data.config.longpress === 3000 ? " selected" : "") +
      ' value="3000">3 seconds</option> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="lowStorageSpace" class="setting">\
                    <option' +
      (setuptools.data.config.lowStorageSpace === true ? " selected" : "") +
      ' value="1">Yes</option> \
                    <option' +
      (setuptools.data.config.lowStorageSpace === false ? " selected" : "") +
      ' value="0">No</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"' +
      ...
      '> \
                ...
                <select name="muleMenu" class="setting">\
                    <option' +
      (setuptools.data.config.muleMenu === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.muleMenu === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="menuPosition" class="setting">\
                    <option' +
      (setuptools.data.config.menuPosition === 0 ? " selected" : "") +
      ' value="0">Left</option> \
                    <option' +
      (setuptools.data.config.menuPosition === 1 ? " selected" : "") +
      ' value="1">Center</option> \
                    <option' +
      (setuptools.data.config.menuPosition === 2 ? " selected" : "") +
      ' value="2">Right</option> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="preventAutoDownload" class="setting"> \
                    <option' +
      (setuptools.data.config.preventAutoDownload === true ? " selected" : "") +
      ' value="1">Yes</option> \
                    <option' +
      (setuptools.data.config.preventAutoDownload === false
        ? " selected"
        : "") +
      ' value="0">No</option> \
                </select> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="recordConsole" class="setting">\
                    <option' +
      (setuptools.data.config.recordConsole === -1 ? " selected" : "") +
      ' value="-1">Automatic Management</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 100 ? " selected" : "") +
      ' value="100">100 entries</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 500 ? " selected" : "") +
      ' value="500">500 entries</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 1000 ? " selected" : "") +
      ' value="1000">1000 entries</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 2000 ? " selected" : "") +
      ' value="2000">2000 entries</option> \
                    <option' +
      (setuptools.data.config.recordConsole === 3000 ? " selected" : "") +
      ' value="3000">3000 entries</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="compression" class="setting">\
                    <option' +
      (setuptools.data.config.compression === true ? " selected" : "") +
      ' value="1">On</option> \
                    <option' +
      (setuptools.data.config.compression === false ? " selected" : "") +
      ' value="0">Off</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="timesync" class="setting">\
                    <option' +
      (setuptools.data.config.timesync === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.timesync === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="nomasonry" class="setting">\
                    <option' +
      (setuptools.data.config.nomasonry === 0 ? " selected" : "") +
      ' value="0">Yes</option> \
                    <option' +
      (setuptools.data.config.nomasonry === 1 ? " selected" : "") +
      ' value="1">No</option> \
                </select> \
            </div> \
            <div class="setuptools link config settings action save menuStyle cfleft noclose">Save Settings</div> \
        ...
        \
        <div class="setuptools containerSettings assistants' +
      (section !== "assistants" ? " hidden" : "") +
      '"> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="accountAssistant" class="setting"> \
                    <option' +
      (setuptools.data.config.accountAssistant === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.accountAssistant === 1 ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="backupAssistant" class="setting"> \
                    <option' +
      (setuptools.data.config.backupAssistant === 0 ? " selected" : "") +
      ' value="0">Off</option>\
                    <option' +
      (setuptools.data.config.backupAssistant === 7 ? " selected" : "") +
      ' value="7">1 week</option> \
                    <option' +
      (setuptools.data.config.backupAssistant === 14 ? " selected" : "") +
      ' value="14">2 weeks</option> \
                    <option' +
      (setuptools.data.config.backupAssistant === 21 ? " selected" : "") +
      ' value="21">3 weeks</option> \
                    <option' +
      (setuptools.data.config.backupAssistant === 28 ? " selected" : "") +
      ' value="28">4 weeks</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="corsAssistant" class="setting">\
                    <option' +
      (setuptools.data.config.corsAssistant === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.corsAssistant === 1 ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <br>&nbsp; \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="tooltipClothing" class="setting"> \
                    <option' +
      (setuptools.data.config.tooltipClothing === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.tooltipClothing === 1 ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                ...
                <select name="tooltipItems" class="setting"> \
                    <option' +
      (setuptools.data.config.tooltipItems === -1 ? " selected" : "") +
      ' value="-1">Off</option> \
                    <option' +
      (setuptools.data.config.tooltipItems === 0 ? " selected" : "") +
      ' value="0">On, Only UIs</option> \
                    <option' +
      (setuptools.data.config.tooltipItems === 1 ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            ...
            <div class="setuptools app config settings"> \
                ...
                <select name="tooltipXPBoost" class="setting"> \
                    <option' +
      (setuptools.data.config.tooltipXPBoost === 0 ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.tooltipXPBoost === 1 ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools link config settings action save menuStyle cfleft noclose">Save Settings</div> \
        </div> \
        <div class="setuptools containerSettings analytics' +
      (section !== "analytics" ? " hidden" : "") +
      '"> \
    '
  );

  var gaStyle = "";
  if (setuptools.data.config.ga === false)
    gaStyle = 'font-style: italic; color: #666666;" title="Analytics Disabled';
  setuptools.lightbox.build(
    "settings",
    ' \
            <h3>Usage Analytics</h3>\
            <div style="margin: 15px 25px;">\
                Usage Analytics provides anonymous information using Google Analytics to help improve the quality and features in Muledump. You can read more about the collected data at our <a href="' +
      setuptools.config.url +
      '/privacy-policy" target="_blank">Privacy Policy</a> page.\
            </div> \
            <div class="setuptools app config settings"> \
                <div id="settings-ga">Enable Analytics</div> \
                <select name="ga" class="setting"> \
                    <option' +
      (setuptools.data.config.ga === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.ga === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                <div id="settings-gaPing" style="' +
      gaStyle +
      '">Activity Ping</div> \
                <select name="gaPing" class="setting"> \
                    <option' +
      (setuptools.data.config.gaPing === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.gaPing === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                <div id="settings-gaErrors" style="' +
      gaStyle +
      '">Errors and Bugs</div> \
                <select name="gaErrors" class="setting"> \
                    <option' +
      (setuptools.data.config.gaErrors === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.gaErrors === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <div class="setuptools app config settings"> \
                <div id="settings-gaOptions" style="' +
      gaStyle +
      '">Options and Features</div> \
                <select name="gaOptions" class="setting"> \
                    <option' +
      (setuptools.data.config.gaOptions === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.gaOptions === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div> \
            <!-- unused \
            <div class="setuptools app config settings"> \
                <div id="settings-gaTotals" style="' +
      gaStyle +
      '">Totals</div> \
                <select name="gaTotals" class="setting"> \
                    <option' +
      (setuptools.data.config.gaTotals === false ? " selected" : "") +
      ' value="0">Off</option> \
                    <option' +
      (setuptools.data.config.gaTotals === true ? " selected" : "") +
      ' value="1">On</option> \
                </select> \
            </div>\
            -->\
  ...
  setuptools.lightbox.build(
    ...
    ' \
        ...
        <div class="setuptools containerSettings system' +
      (section !== "system" ? " hidden" : "") +
      '"> \
  ...
  setuptools.lightbox.drawhelp(
    "settings",
    "docs/setuptools/help/settings-manager",
    "Muledump Settings Help"
  );
  setuptools.lightbox.display("settings", { variant: "fl-Settings" });
  if (typeof highlight === "string")
    $("#settings-" + highlight).html(
      "<strong>" + $("#settings-" + highlight).text() + "</strong>"
    );

  $(".setuptools.link.mulecrypt").click(setuptools.app.mulecrypt.ui.index);

  //  switch settings category
  $(".setuptools.link.switchSettings").click(async function () {
    var switchTo = false;
  ...
  $(".setuptools.link.resetOptions").click(async function () {
    setuptools.lightbox.build(
      "settings-resetOptions-confirm",
      ' \
    ...
    setuptools.lightbox.display("settings-resetOptions-confirm", {
      variant: "fl-SettingsSmall nobackground",
    });

    $(".setuptools.link.resetOptions.confirm").click(async function () {
      ...
      // save
      try {
        localStorage["muledump:options"] = JSON.stringify(
          window.options,
          null,
          4
        );
        ...
        setuptools.lightbox.build(
          "settings-resetOptions-error",
          "There was an error resetting options."
        );
      ...
      window.relayout();
      setuptools.lightbox.build(
        "settings-resetOptions-complete",
  ...
  $(".setuptools.link.config.settings.action.viewSystemsReport").on(
    "click.setuptools.viewSystemsReport",
    setuptools.app.devtools.viewSystemsReport
  );

  //  erase muledump secondary cache
  $(".setuptools.link.config.settings.action.eraseSecondaryCache").click(
    async function () {
      setuptools.lightbox.build(
        "settings-eraseSecondaryCache-confirm",
        ' \
      ...
      setuptools.lightbox.display("settings-eraseSecondaryCache-confirm", {
        variant: "fl-SettingsSmall",
      });

      $(".setuptools.link.eraseSecondaryCache.confirm").click(
        async function () {
          setuptools.app.muledump.cleanupSecondaryCache();
          setuptools.lightbox.build(
            "settings-eraseSecondaryCache-complete",
            "All secondary cache data has been erased. Reload Muledump for it to take effect."
          );
  ...
  $(".setuptools.link.config.settings.action.eraseAccountCache").click(
    async function () {
      setuptools.lightbox.build(
        "settings-eraseAccountCache-confirm",
        ' \
      ...
      setuptools.lightbox.display("settings-eraseAccountCache-confirm", {
        variant: "fl-SettingsSmall",
      });

      $(".setuptools.link.eraseAccountCache.confirm").click(async function () {
        ...
        setuptools.lightbox.build(
          "settings-eraseAccountCache-complete",
          "All account data cache has been erased. Reload Muledump for it to take effect."
        );
  ...
  $(".setuptools.link.config.settings.action.eraseAll").click(
    async function () {
      setuptools.lightbox.build(
        "settings-eraseAll-confirm",
        ' \
      ...
      $(".setuptools.link.eraseAll.confirm").click(async function () {
        setuptools.lightbox.close("settings");
        for (var i in localStorage)
          if (localStorage.hasOwnProperty(i))
            if (i.match(/^muledump:.*$/)) localStorage.removeItem(i);

        setuptools.lightbox.build(
          "settings-eraseAll-complete",
          "All data has been erased. This window reload in a few seconds."
        );
  ...
  $(".setuptools.link.config.settings.action.destroy").click(async function () {
    ...
    $(".setuptools.app.config.settings select").each(function () {
      ...
      if (
        ...
        if (name === "enabled" && setuptools.state.hosted === true)
          newvalue = 1;
      ...
      if (newvalue !== false)
        $(
          '.setuptools.app.config select[name="' +
            name +
            '"] option[value="' +
            newvalue +
            '"]'
    ...
    setuptools.data.config.mqDisplayIgn =
      setuptools.copy.data.config.mqDisplayIgn;
  });

  //  assist user in erasing setuptools configuration
  $(".setuptools.link.config.settings.action.arrrrgbaaad").click(
    async function () {
      setuptools.lightbox.build(
      ...
      setuptools.lightbox.display("settings-erase-confirm", {
        variant: "fl-SettingsSmall",
      });
      ...
      $(".setuptools.link.erase").click(function () {
        ...
        if (clearBackups === false) {
          ...
          for (var i in BackupList)
            if (BackupList.hasOwnProperty(i)) BackupKeys.push(BackupList[i][0]);
        }
        ...
        for (var i in localStorage)
          if (localStorage.hasOwnProperty(i))
            if (
              i.match(setuptools.config.regex.storageKeys) &&
              BackupKeys.indexOf(i) === -1
            )
              delete localStorage[i];

        setuptools.lightbox.build(
          "settings-erase-completed",
          " \
                SetupTools configuration has been erased. \
                " +
            (BackupList.length > 0 && BackupKeys.length === 0
              ? "<br><br>Erased " + BackupList.length + " backups."
              : "") +
            " \
  ...
  $(".setuptools.link.config.settings.save").click(async function () {
    $(this).unbind("click");
    ...
    var settings = {};
    settings.enabled =
      $('.setuptools.app.config.settings select[name="enabled"]').val() === "1";
    if (setuptools.data.config.enabled === true) {
      Reroll = false;
      settings.preventAutoDownload =
        $(
          '.setuptools.app.config.settings select[name="preventAutoDownload"]'
        ).val() === "1";
      settings.maximumBackupCount = Number(
        $(
          '.setuptools.app.config.settings select[name="maximumBackupCount"]'
        ).val()
      );
      settings.autocomplete =
        $(
          '.setuptools.app.config.settings select[name="autocomplete"]'
        ).val() === "1";
      settings.automaticBackups =
        $(
          '.setuptools.app.config.settings select[name="automaticBackups"]'
        ).val() === "1";
      settings.badaccounts = Number(
        $('.setuptools.app.config.settings select[name="badaccounts"]').val()
      );
      settings.rowlength = Number(
        $('.setuptools.app.config.settings select[name="rowlength"]').val()
      );
      settings.rowwrap =
        $('.setuptools.app.config.settings select[name="rowwrap"]').val() ===
        "yes"
          ? true
          : false;
      console.log(
      ...
      settings.accountLoadDelay = Number(
        $(
          '.setuptools.app.config.settings select[name="accountLoadDelay"]'
        ).val()
      );
      settings.totalswidth = Number(
        $('.setuptools.app.config.settings select[name="totalswidth"]').val()
      );
      settings.mulelogin =
        $('.setuptools.app.config.settings select[name="mulelogin"]').val() ===
        "1"
          ? 1
          : 0;
      settings.muleMenu =
        $('.setuptools.app.config.settings select[name="muleMenu"]').val() ===
        "1";
      settings.nomasonry =
        $('.setuptools.app.config.settings select[name="nomasonry"]').val() ===
        "0"
          ? 0
          : 1;
      settings.errors =
        $('.setuptools.app.config.settings select[name="errors"]').val() ===
        "1";
      settings.equipSilhouettes =
        $(
          '.setuptools.app.config.settings select[name="equipSilhouettes"]'
        ).val() === "1";
      settings.hideHeaderText =
        $(
          '.setuptools.app.config.settings select[name="hideHeaderText"]'
        ).val() === "1";
      settings.debugging =
        $('.setuptools.app.config.settings select[name="debugging"]').val() ===
        "1";
      settings.compression =
        $(
          '.setuptools.app.config.settings select[name="compression"]'
        ).val() === "1";
      settings.timesync =
        $('.setuptools.app.config.settings select[name="timesync"]').val() ===
        "1";
      settings.groupsMergeMode = Number(
        $(
          '.setuptools.app.config.settings select[name="groupsMergeMode"]'
        ).val()
      );
      settings.autoReloadDays = Number(
        $('.setuptools.app.config.settings select[name="autoReloadDays"]').val()
      );
      settings.menuPosition = Number(
        $('.setuptools.app.config.settings select[name="menuPosition"]').val()
      );
      settings.keyBindings = Number(
        $('.setuptools.app.config.settings select[name="keyBindings"]').val()
      );
      settings.lazySave = Number(
        $('.setuptools.app.config.settings select[name="lazySave"]').val()
      );
      settings.longpress = Number(
        $('.setuptools.app.config.settings select[name="longpress"]').val()
      );
      settings.lowStorageSpace =
        $(
          '.setuptools.app.config.settings select[name="lowStorageSpace"]'
        ).val() === "1";
      settings.accountsPerPage = Number(
        $(
          '.setuptools.app.config.settings select[name="accountsPerPage"]'
        ).val()
      );
      settings.corsAssistant = Number(
        $('.setuptools.app.config.settings select[name="corsAssistant"]').val()
      );
      settings.backupAssistant = Number(
        $(
          '.setuptools.app.config.settings select[name="backupAssistant"]'
        ).val()
      );
      settings.accountAssistant = Number(
        $(
          '.setuptools.app.config.settings select[name="accountAssistant"]'
        ).val()
      );
      settings.animations = Number(
        $('.setuptools.app.config.settings select[name="animations"]').val()
      );
      settings.giftChestWidth = Number(
        $('.setuptools.app.config.settings select[name="giftChestWidth"]').val()
      );
      settings.pagesearch = Number(
        $('.setuptools.app.config.settings select[name="pagesearch"]').val()
      );
      settings.totalsExportWidth = Number(
        $(
          '.setuptools.app.config.settings select[name="totalsExportWidth"]'
        ).val()
      );
      settings.exportDefault = Number(
        $('.setuptools.app.config.settings select[name="exportDefault"]').val()
      );
      settings.recordConsole = Number(
        $('.setuptools.app.config.settings select[name="recordConsole"]').val()
      );
      settings.tooltipClothing = Number(
        $(
          '.setuptools.app.config.settings select[name="tooltipClothing"]'
        ).val()
      );
      settings.tooltipItems = Number(
        $('.setuptools.app.config.settings select[name="tooltipItems"]').val()
      );
      settings.tooltipXPBoost = Number(
        $('.setuptools.app.config.settings select[name="tooltipXPBoost"]').val()
      );
      settings.ga =
        $('.setuptools.app.config.settings select[name="ga"]').val() === "1";
      settings.gaErrors =
        $('.setuptools.app.config.settings select[name="gaErrors"]').val() ===
        "1";
      settings.gaOptions =
        $('.setuptools.app.config.settings select[name="gaOptions"]').val() ===
        "1";
      settings.gaPing =
        $('.setuptools.app.config.settings select[name="gaPing"]').val() ===
        "1";
      settings.gaTotals =
        $('.setuptools.app.config.settings select[name="gaTotals"]').val() ===
        "1";
    }

    if (setuptools.state.hosted === true) {
      settings.alertNewVersion = Number(
        $(
          '.setuptools.app.config.settings select[name="alertNewVersion"]'
        ).val()
      );
    ...
    for (var i in settings)
      if (settings.hasOwnProperty(i)) setuptools.data.config[i] = settings[i];

    //  if the user had been disabled we need to reroll their original config back into setuptools.data.config
    if (Reroll === true) {
      var ImportData = JSON.parse(
        await setuptools.storage.read("configuration")
      );
      for (var i in ImportData.config)
        if (ImportData.config.hasOwnProperty(i))
          if (i !== "enabled") setuptools.data.config[i] = ImportData.config[i];
    }

    setuptools.lightbox.close("settings");

    //  save the configuration
    if ((await setuptools.app.config.save("SettingsManager/Save")) === false) {
      setuptools.app.config.saveError();
    } else {
      setuptools.lightbox.build(
        "settings-saved",
        "Settings have been saved. <br><br>This page will reload in a few seconds."
      );
      ...
      $(".setuptools.goback").click(async function () {
...
setuptools.app.config.backup = async function (backupProtected, auto) {
  ...
  var BackupData = JSON.stringify(
    $.extend(
      ...
      setuptools.data,
      {
        additional: {
          mulequeue: {
            state: await setuptools.app.mulequeue.task.saveConfig(true),
  ...
  var BackupStatus = await setuptools.storage.write(BackupID, BackupData);
...
setuptools.app.config.convert = function (accountConfig, format, group, all) {
  ...
  if (format === 0) {
    ...
    if (setuptools.app.config.validateFormat(accountConfig, 1) === true) {
      ...
      for (var i in accountConfig.accounts)
        if (accountConfig.accounts.hasOwnProperty(i))
          if (
            all === true ||
            (!group && accountConfig.accounts[i].enabled === true) ||
            (group &&
              setuptools.data.groups.groupList[group].members.indexOf(i) > -1)
          )
      ...
      setuptools.lightbox.error(
        "Account configuration format " +
          accountConfig.meta.format +
      ...
      setuptools.lightbox.error(
        "Supplied configuration is not of a known format.",
        7
      );
    ...
    setuptools.lightbox.error("Request format for conversion is unknown", 5);
};
  ...
  if (format === 0) {
    ...
    for (var i in accountConfig)
      if (accountConfig.hasOwnProperty(i))
        if (
          !i.match(setuptools.config.regex.email) &&
          !i.match(setuptools.config.regex.guid)
        )
          return false;
...
setuptools.app.config.determineFormat = function (accountConfig) {
  if (setuptools.app.config.validateFormat(accountConfig, 1) === true) {
    ...
    setuptools.lightbox.error(
      "Supplied account configuration is of an unknown format.",
      14
    );
};
...
setuptools.app.config.userToggle = function (username) {
  if (
    ...
    setuptools.data.accounts.accounts[username]
  ) {
    setuptools.data.accounts.accounts[username].enabled =
      !setuptools.data.accounts.accounts[username].enabled;
...
setuptools.app.config.userDelete = function (guid) {
  if (
    setuptools.state.loaded === true &&
    setuptools.data.accounts.accounts[guid]
  ) {
    ...
    setuptools.app.muledump.pagesearch.state.list =
      setuptools.app.muledump.pagesearch.state.list.filter(function (data) {
        return !(data.username === guid);
      });

    setuptools.app.muledump.pagesearch.paginate.PageList =
      setuptools.app.muledump.pagesearch.paginate.PageList.filter(function (
        data
      ) {
        return !(data.username === guid);
      });
...
setuptools.app.config.createUser = function (
  username,
  AccountDataInput,
  action,
  format
  ...
  if (format === 0) {
    ...
    if (
      ...
      setuptools.lightbox.error(
        "Cannot set user on an invalid format configuration",
        12
      );
    ...
    accountConfig = $.extend(
      true,
      {},
      setuptools.objects.accounts,
      AccountData
    );

    if (action === "set") {
      if (
        setuptools.app.config.validateFormat(setuptools.data.accounts, 1) ===
        true
      ) {
...
setuptools.app.config.listUsers = function (id, enabled) {
  ...
  function UserObject(guid) {
    ...
    if (
      setuptools.data.accounts.accounts[guid] &&
      typeof result.accounts[guid] === "undefined"
    ) {
      //  if enabled is specified we'll only show accounts matching this value
      if (
        typeof result.meta.terms.enabled === "undefined" ||
        (typeof result.meta.terms.enabled === "boolean" &&
          result.meta.terms.enabled ===
      ...
      if (result.meta.duplicates.list.indexOf(guid) === -1)
        result.meta.duplicates.list.push(guid);
    }
  }
  ...
  if (typeof id === "string" && setuptools.data.groups[id]) {
    ...
    typeof id === "string" &&
    (setuptools.data.accounts.accounts[id] ||
      setuptools.data.accounts.accounts[id])
  ) {
    UserObject(id);
    ...
    if (setuptools.app.config.determineFormat(setuptools.data.accounts) === 1) {
      ...
      setuptools.lightbox.error(
        "ListUsers only supports users migrated to SetupTools.",
        26
      );
  }
...
setuptools.app.config.create = function (accountConfig, format) {
  ...
  if (format === 1) {
    if (setuptools.app.config.validateFormat(accountConfig, 0) === true) {
      ...
      for (var i in accountConfig)
        if (accountConfig.hasOwnProperty(i))
          accountData.accounts[i] = setuptools.app.config.createUser(
            i,
            accountConfig[i],
            "return",
            1
      ...
      setuptools.lightbox.error(
        "The supplied account configuration was invalid.",
        8
      );
      return;
    }
    ...
    setuptools.lightbox.error(
      "Requested configuration format " + format + " does not exist.",
      9
    );
    return;
  }
...
setuptools.app.config.generateAccountsJS = function (accountConfig) {
  if (typeof accountConfig === "undefined")
    accountConfig = setuptools.data.accounts;
  ...
  for (var i in keys) rest += "\n" + i + " = " + keys[i] + ";";

  return btoa(
    "accounts = " +
      JSON.stringify(setuptools.app.config.convert(accountConfig, 0), null, 4) +
      rest +
      "\n"
  );
};
...
setuptools.app.config.saveError = function () {
  var AccountsJS = setuptools.app.config.generateAccountsJS(
  ...
  setuptools.lightbox.build(
    ...
    ' \
            ...
            <br><br><a download="accounts.js" href="data:text/json;base64,' +
      AccountsJS +
      '" class="setuptools config download">Download accounts.js</a> \
        '
  );
  setuptools.lightbox.display("saveerror", {
...
setuptools.app.config.save = async function (message, lazy) {
  if (setuptools.state.firsttime === false && setuptools.state.loaded === false)
    return;
  //  seems reasonable
  if (typeof message !== "string") message = "";
  if (
    setuptools.state.error === false &&
    setuptools.config.devForcePoint !== "config-save"
  ) {
    if (lazy === true && setuptools.data.config.lazySave > 0) {
      setuptools.app.techlog("Added request to lazySave");
      if (Array.isArray(setuptools.tmp.lazySaveData) === false)
        setuptools.tmp.lazySaveData = [];
    ...
    if (
      ...
      setuptools.data.accounts = setuptools.app.config.create(
        setuptools.data.accounts,
        "1"
      );
    ...
    var saveResult = await setuptools.storage.write(
      "configuration",
      JSON.stringify(setuptools.data, null, 5)
    );
    window.techlog(
      "SetupTools/Configuration " +
        (saveResult === false ? "error " : "") +
        "saving version " +
        setuptools.data.accounts.meta.version +
...
setuptools.app.config.lazySaveCancel = function (all) {
  ...
  if (setuptools.tmp.lazySaveData.length === 0 || all === true)
  ...
  setuptools.tmp.lazySaveTask = setInterval(function () {
    if (Array.isArray(setuptools.tmp.lazySaveData) === true) {
      setuptools.app.config.save(
        "Lazily saving client configuration (+" +
          setuptools.tmp.lazySaveData.length +
          ")",
        "force"
      );
